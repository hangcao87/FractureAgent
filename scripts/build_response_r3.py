...
def build(out: str):
    ...
    add_labelled(doc, "Response: ", "We agree with the Reviewer. We replaced the structured abstract with a single unstructured paragraph and shortened it while clarifying the argument flow: the clinical-support gap is stated first, followed by the proposed tool-augmented method, the essential training and evaluation design, the principal quantitative findings and the simulation-based limitation.")
