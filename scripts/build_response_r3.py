...
def build(out: str):
    ...
    add_labelled(doc, "Manuscript location: ", "Introduction, contribution summary; Discussion, Section 7.2; Conclusion, Section 8; Declarations, Availability of data and materials and Code availability.", color=RED)

    add_labelled(doc, "Manuscript change checklist", "", color=BLUE)
    for item in [
        "Abstract: converted the structured Background/Methods/Results/Conclusions format into a 195-word unstructured paragraph and reproduced the complete revision above.",
        "Declarations: stated separately why the curated training corpus and trained weights/checkpoints are not publicly distributed and added the derived-data request route.",
