...
def main() -> None:
    ...
    abstract = (
        "Post-fracture rehabilitation is prolonged and individualized, yet many digital tools provide static guidance between clinic visits. "
        "We developed FractureAgent, a ReAct-style intelligent agent built on a domain-adapted Qwen3.5-9B backbone and equipped with five typed tools "
        "for exercise retrieval, pain assessment, functional-progress tracking, literature retrieval and reminder planning. The model was adapted "
        "with QLoRA supervised instruction tuning on 18,742 synthetic rehabilitation dialogues and tool-use traces constructed from open-access clinical "
        "and patient-education sources. We evaluated the agent using automated functional metrics, expert clinical ratings and 210 simulated-patient "
        "scenarios covering six fracture types and three rehabilitation phases. FractureAgent achieved a task completion rate of 91.4%, a mean expert "
        ...
        "sensitivity of 0.843. It outperformed the evaluated baselines, including the same unfine-tuned Qwen3.5-9B backbone. These findings support "
        "technical feasibility in simulated scenarios, but do not establish clinical effectiveness or readiness for deployment."
    )
    data_text = (
